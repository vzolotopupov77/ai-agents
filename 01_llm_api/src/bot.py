...
# Максимум сообщений диалога (user + assistant) в истории; системный промпт всегда остаётся.
...
class ChatBot:
    ...
    def add_message(self, role: str, content: str):
        ...
        if len(dialog) > MAX_HISTORY_MESSAGES:
            dialog = dialog[-MAX_HISTORY_MESSAGES:]
        self.conversation_history = prefix + dialog
