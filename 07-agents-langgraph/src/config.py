...
class Config:
    ...
    # LangSmith настройки (LANGCHAIN_* — стандарт SDK, LANGSMITH_* — fallback)
    LANGSMITH_API_KEY = os.getenv("LANGCHAIN_API_KEY") or os.getenv("LANGSMITH_API_KEY")
    _tracing = os.getenv("LANGCHAIN_TRACING_V2") or os.getenv("LANGSMITH_TRACING_V2") or os.getenv("LANGSMITH_TRACING") or "false"
    LANGSMITH_TRACING_V2 = _tracing.lower() == "true"
    LANGSMITH_PROJECT = os.getenv("LANGCHAIN_PROJECT") or os.getenv("LANGSMITH_PROJECT", "rag-assistant")
