...
class Config:
    ...
    # Guard Middleware Configuration
    GUARD_PII_CREDIT_CARD_ENABLED = os.getenv("GUARD_PII_CREDIT_CARD_ENABLED", "true").lower() == "true"
    GUARD_PII_CREDIT_CARD_STRATEGY = os.getenv("GUARD_PII_CREDIT_CARD_STRATEGY", "mask")  # mask/redact
    GUARD_MODEL_CALL_LIMIT = int(os.getenv("GUARD_MODEL_CALL_LIMIT", "2"))
    GUARD_TOOL_CALL_LIMIT = int(os.getenv("GUARD_TOOL_CALL_LIMIT", "2"))
    GUARD_LIMITS_EXIT_BEHAVIOR = os.getenv("GUARD_LIMITS_EXIT_BEHAVIOR", "end")  # end/error
    ...
    # Agent Evaluation (E2E Tests) - LLM-as-Judge для траекторной оценки
    AGENTEVALS_LLM_MODEL = os.getenv("AGENTEVALS_LLM_MODEL", "openai:gpt-4o")
